  ...
  <div>
    <div class="flex header">
      ...
      <el-input
        ...
        @click="search"
      ></el-input>
      <div class="title">班级状态：</div>
      <el-select v-model="searchStatus" placeholder="请选择您要搜索的班级状态" clearable>
      ...
      <el-button size="small" type="primary" @click="addMajor">新增班级</el-button>
    </div>
...
export default {
  ...
  methods: {
    // 搜索
    search() {
      if (this.searchInfo === '' && this.searchStatus === '') return this.$message.warning('请输入班级名称再搜索');
      this.page = 1;
      this.getData();
    },
    async getData() {
